...
import hbase.Endpoint.MyFirstCoprocessor;
import hbase.Endpoint.MyFirstCoprocessorEndPoint;
 ...
 * 公众号：Hadoop实操
 */
 class MyFirstCoprocessExample {

    public static void main(String[] args) {
        String table_name = "cdc_table";

        //初始化HBase配置
        Configuration configuration = HBaseConfiguration.create();
        configuration.set("hbase.zookeeper.property.clientPort", "2181");
        configuration.setStrings("hbase.zookeeper.quorum", "RedHatLv11,RedHatLv12,RedHatLv13,RedHatLv14");
        try {
            ...
            //为指定的表添加协处理器
            String hdfspath = "hdfs://RedHatLv14:9000/lvxian_home/flink_kafka-1.0-SNAPSHOT-shaded.jar";
            setupToExistTable(connection, table, hdfspath, MyFirstCoprocessorEndPoint.class);

            //客户端调用Region端的协处理器
            execFastEndpointCoprocessor(table, "info", "age:MAX,age:MIN,age:AVG,age:SUM,age:COUNT");
