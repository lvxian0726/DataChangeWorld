...
//
//        flinkConfiguration.set(YarnConfigOptions.VCORES, 1);   //每个yarn container的core设置
//        flinkConfiguration.set(YarnConfigOptions.APP_MASTER_VCORES, 1); // JobManager core 配置
//
//        flinkConfiguration.set(JobManagerOptions.JOB_MANAGER_HEAP_MEMORY, "1024m"); // JobManager 内存配置
//
//
...
//
//        flinkConfiguration.set(YarnConfigOptions.SHIP_DIRECTORIES, list);  //flink job依赖包
//
//        flinkConfiguration.set(SavepointConfigOptions.SAVEPOINT_PATH, "hdfs://RedHatLv14:9000/flink-1.10.0-savepoints/savepoint-c99a00-8fb68d38d890"); //设置flink 从指定savepoint path启动
...
//
//        flinkConfiguration.set(TaskManagerOptions.MANAGED_MEMORY_SIZE, new MemorySize(1024 * 1024 * 1024));  //设置taskManager内存
//
//        flinkConfiguration.set(DeploymentOptions.TARGET, "yarn-per-job"); //设置部署模式
//
//        flinkConfiguration.set(DeploymentOptions.ATTACHED, false);
//
//        flinkConfiguration.set(TaskManagerOptions.NUM_TASK_SLOTS, 2); //设置taskManager槽数
//
//
...
//                .setSavepointRestoreSettings(SavepointRestoreSettings.fromConfiguration(flinkConfiguration))
